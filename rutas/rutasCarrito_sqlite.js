...
const routerCarrito_sql = express.Router();
const dbcarrito_sql = require('../persistencias/dbcarrito_sql.js');

const database = new dbcarrito_sql.DBCarrito_SQL();

routerCarrito_sql.get("/carrito/:id?", async (req, res) => {
...
routerCarrito_sql.post("/carrito/nuevoCarrito/:id", (req, res) => {
...
routerCarrito_sql.post("/carrito/:id", async (req, res) => {
...
routerCarrito_sql.delete("/carrito/:id", async (req, res) => {
...
module.exports = routerCarrito_sql;