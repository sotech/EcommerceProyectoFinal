...
routerProductos_mariadb.post("/productos/", async (req, res) => {
    console.log("POST");
...
routerProductos_mariadb.put("/productos/:id", async (req, res) => {
    console.log("PUT");
...
routerProductos_mariadb.delete("/productos/:id", async (req, res) => {
    console.log("DELETE");
...
module.exports = routerProductos_mariadb;